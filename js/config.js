...
frmLinkLabel:["lblLink"] //lblLink  frmShareLinkLabel
	...
	shareObj = [{"name":"QQ空间","url":"http://sns.qzone.qq.com/cgi-bin/qzshare/cgi_qzshare_onekey?url=${url}&title=${title}","logo":"./pdfReader/images/qzone.ico","title":"QQ空间"},{"name":"新浪微博","url":"http://v.t.sina.com.cn/share/share.php?url=${url}&title=${title}","logo":"./pdfReader/images/sina_weibo.ico","title":"新浪微博"}];
